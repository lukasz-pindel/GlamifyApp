...
namespace Glamify.Infrastructure.Migrations
{
    ...
    [Migration("20240508204437_BusinessRelationAdjustments")]
    partial class BusinessRelationAdjustments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Glamify.Domain.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Glamify.Domain.Entities.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Glamify.Domain.Entities.Business", b =>
                {
                    b.HasOne("Glamify.Domain.Entities.User", "Owner")
            ...
            modelBuilder.Entity("Glamify.Domain.Entities.Comment", b =>
                {
                    b.HasOne("Glamify.Domain.Entities.Rating", "Rating")
                        .WithOne("Comment")
                        .HasForeignKey("Glamify.Domain.Entities.Comment", "RatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
