...
export const placesInCategories: Category = {
    barbers: Array.from({ length: 10 }, (_, i) => ({
        ...
        logo: 'path-to-barber-logo.jpg' // Replace with actual path or use placeholders
    })),
    spas: Array.from({ length: 10 }, (_, i) => ({
        id: i + 11,
        name: `Spa #${i + 1}`,
        address: `${200 + i} Spa Blvd, YourCity`,
        logo: 'path-to-spa-logo.jpg' // Replace with actual path or use placeholders
    })),
    nailSalons: Array.from({ length: 10 }, (_, i) => ({
        id: i + 21,
        name: `Nail Salon #${i + 1}`,
        address: `${300 + i} Nail Rd, YourCity`,
        logo: 'path-to-nail-salon-logo.jpg' // Replace with actual path or use placeholders
    })),
    massagePlaces: Array.from({ length: 10 }, (_, i) => ({
        id: i + 31,
        name: `Massage Place #${i + 1}`,
        address: `${400 + i} Massage Ln, YourCity`,
        logo: 'path-to-massage-place-logo.jpg' // Replace with actual path or use placeholders
    }))
};