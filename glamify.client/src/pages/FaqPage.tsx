    ...
    <div style={{ padding: "20px", minHeight: "800px" }}>
      ...
      <Accordion>
        ...
        <Accordion.Item eventKey="1" className="mb-3">
          ...
          <Accordion.Body>
            We offer a wide range of services including hair salons, nail care, and massage therapy.
            Each category has various specific options that you can view and book through our app.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="2" className="mb-3">
          ...
          <Accordion.Body>
            ...
            charge. Cancellations made less than 24 hours before the appointment time may incur a
            fee.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="4" className="mb-3">
          ...
          <Accordion.Body>
            Yes, we periodically offer discounts and promotions on various services. Keep an eye on
            our app notifications and your email for exclusive deals and offers.
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
    </div>
