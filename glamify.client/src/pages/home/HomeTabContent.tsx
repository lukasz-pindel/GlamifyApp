        ...
        <Container style={{ minHeight: "800px" }}>
            <Row className="justify-content-center my-4">
                <Col md={8}>
                    ...
                    <p className="mt-3">
                        Easily schedule and manage appointments at any time, from anywhere. 
                        Whether it's for haircuts, spa treatments, or medical consultations, 
                        our user-friendly platform makes booking your next appointment hassle-free.
                    </p>
                    <p className="mt-2">
