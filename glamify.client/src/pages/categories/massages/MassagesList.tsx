        ...
        <Container className="mb-5 mt-5">
            ...
            {massages.map(massage => (
                <Row key={massage.id} className="mb-3">
                    <Col md={4}>
                        <Card>
                            <Card.Img variant="top" src={massage.logo} alt={massage.name} style={{ width: '100%', height: '200px', objectFit: 'cover' }} />
                        </Card>
                    </Col>
                    <Col md={4}>
                        <Card.Body>
                    ...
                    <Col md={4} className="text-md-right">
                        <Button variant="primary" onClick={() => handleBooking(massage.id)} className="book-btn">Book</Button>
                    </Col>
                </Row>
            ))}
        </Container>
