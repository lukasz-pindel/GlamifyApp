        ...
        <Container style={{ padding: '20px', minHeight: '800px', marginTop: '200px' }}>
            ...
            <Form onSubmit={handleSubmit} style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                ...
                <Form.Group as={Row} controlId="formHorizontalMessage">
                    ...
                    <Col sm={10}>
                        <Form.Control as="textarea" rows={3} placeholder="Your Message" required className='mb-4'/>
                    </Col>
                </Form.Group>
                <Button type="submit" variant='outline-dark' style={{ width: '150px', margin: '0 auto', display: 'block' }}>Send Message</Button>
            </Form>
        </Container>
    );
}
